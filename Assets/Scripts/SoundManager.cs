...
public class SoundManager : MonoBehaviour
{
    ...
    // 버튼에서의 사운드 재생
    public void PlaySoundFromButton(string _name)
    {
        PlaySound(_name, SoundType.Sfx);
    }
    ...
    AudioSource CreateNewSoundPlayer()
    {
        ...
        go.transform.parent = transform; // 이 구문이 없는 경우 : Scene 이동 시 플레이어가 없는 상태 = bgm등이 처음부터 다시 재생
