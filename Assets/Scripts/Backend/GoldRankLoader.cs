...
public class GoldRankLoader : MonoBehaviour
{
    [SerializeField]
	...
	{
		// 1 ~ 20위 랭킹 정보 불러오기
		Backend.URank.User.GetRankList(Constants.GOLD_RANK_UUID, Constants.MAX_RANK_LIST, callback =>
		{
	...
	{
		// 내 랭킹 정보 불러오기
		Backend.URank.User.GetMyRank(Constants.GOLD_RANK_UUID, callback =>
		{
